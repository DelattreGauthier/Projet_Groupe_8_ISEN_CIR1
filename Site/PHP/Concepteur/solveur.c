...
//On défini la structure Case avec les 4 directions différentes
typedef struct {
    bool top;
    bool right;
    bool left;
...
//On décale les valeurs de direction d'une case en fonction de la rotation
...
int main() {
    ...
    if (taille != 6 && taille != 8 && taille != 10 && taille != 12) {
        printf("Taille invalide. La taille doit �tre 6, 8, 10 ou 12.\n");
        fclose(fptr);
        return 1;
    }
    printf("Taille : %d\n", taille);
